  ...
  return (
    <div>
      ...
      <section className="border-b border-[#121212]">
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="lg:col-span-8 p-8 md:p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-[#121212]">
            ...
            <p className="text-[#6B6B6B] mt-8 max-w-[560px]" style={{ lineHeight: 1.7 }}>
              {job.summary}
            </p>
          </div>
          ...
          <div className="lg:col-span-4 p-8 md:p-12 lg:p-16 flex flex-col justify-between gap-8">
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                <MapPin size={16} className="text-[#FF4F00] mt-0.5 shrink-0" strokeWidth={1.5} />
                <div>
              ...
              <div className="flex items-start gap-3">
                <Clock size={16} className="text-[#FF4F00] mt-0.5 shrink-0" strokeWidth={1.5} />
                <div>
                  <p className="uppercase tracking-[0.15em] text-[#6B6B6B] mb-1" style={{ fontSize: '0.6rem', fontWeight: 700 }}>
                    Type
                  </p>
              ...
              <div className="flex items-start gap-3">
                <Briefcase size={16} className="text-[#FF4F00] mt-0.5 shrink-0" strokeWidth={1.5} />
                <div>
                  <p className="uppercase tracking-[0.15em] text-[#6B6B6B] mb-1" style={{ fontSize: '0.6rem', fontWeight: 700 }}>
                    Department
                  </p>
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-3 bg-[#121212] text-[#F9F9F7] px-8 py-5 uppercase tracking-[0.1em] hover:bg-[#FF4F00] transition-colors w-full"
      ...
      <section className="border-b border-[#121212]">
        <div className="grid grid-cols-1 lg:grid-cols-12">
          {/* Main content */}
          <div className="lg:col-span-8 border-b lg:border-b-0 lg:border-r border-[#121212]">
            {/* Description */}
            {job.description?.html && (
              <div className="px-8 md:px-12 lg:px-16 py-6 md:py-8">
                ...
                <div
                  className="text-[#6B6B6B] prose max-w-none"
                ...
                <ul className="space-y-4">
                  {job.responsibilities.map((item, i) => (
                    <li key={i} className="flex items-start gap-4">
                      <span
                        className="text-[#FF4F00] shrink-0 mt-0.5"
                        style={{ fontWeight: 900, fontFamily: "'Space Grotesk', sans-serif", fontSize: '0.75rem' }}
                      >
                ...
                <ul className="space-y-3">
                  {job.requirements.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <span className="mt-2 shrink-0 w-1.5 h-1.5 rounded-full bg-[#FF4F00]" />
                      <p className="text-[#6B6B6B]" style={{ lineHeight: 1.7 }}>
                        {item}
                      </p>
                    </li>
              ...
              <div className="mb-12">
                ...
                <ul className="space-y-3">
                  {job.niceToHave.map((item, i) => (
                    <li key={i} className="border border-[#121212] p-4">
                      <p className="text-[#6B6B6B]" style={{ lineHeight: 1.6, fontSize: '0.9rem' }}>
                        {item}
                      </p>
                    </li>
                  ))}
                ...
                <div className="space-y-2">
                  {otherJobs.map((other) => (
                    <Link
                      ...
                      className="flex items-center justify-between p-4 border border-[#121212] hover:bg-[#121212] hover:text-[#F9F9F7] transition-colors group"
                    >
                      <div>
                        <p style={{ fontWeight: 600, fontSize: '0.85rem' }}>{other.title}</p>
                        <p
                          className="text-[#6B6B6B] group-hover:text-[#F9F9F7]/50 uppercase tracking-[0.1em]"
                          style={{ fontSize: '0.6rem', fontWeight: 700, marginTop: '2px' }}
                        >
                          {other.department}
                        </p>
                      </div>
                      <ArrowRight size={13} className="text-[#FF4F00] shrink-0" />
                    </Link>
                  ))}
                </div>
              </div>
      ...
      {/* Apply CTA */}
      <section className="bg-[#121212] text-[#F9F9F7]">
        <div className="p-8 md:p-12 lg:p-20 text-center flex flex-col items-center">
          <p className="uppercase tracking-[0.2em] text-[#F9F9F7]/40 mb-6" style={{ fontSize: '0.65rem', fontWeight: 700 }}>
            Interested?
          </p>
          <h2 className="text-[#F9F9F7] mb-8">
            Apply for
            <br />
            this role<span className="text-[#FF4F00]">.</span>
          </h2>
          <a
            href={`mailto:careers@hybikes.com?subject=Application — ${job.title}`}
