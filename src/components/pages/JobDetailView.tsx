      ...
      <section className="border-b border-primary">
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="lg:col-span-8 p-8 md:p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-primary">
            ...
            <p className="text-muted mt-8 max-w-[560px]" style={{ lineHeight: 1.7 }}>
              {job.summary}
            </p>
          </div>
          ...
          <div className="lg:col-span-4 p-8 md:p-12 lg:p-16 flex flex-col justify-between gap-8">
            <div className="space-y-6">
              <div className="flex items-start gap-3">
                <MapPin size={16} className="text-accent mt-0.5 shrink-0" strokeWidth={1.5} />
                <div>
              ...
              <div className="flex items-start gap-3">
                <Clock size={16} className="text-accent mt-0.5 shrink-0" strokeWidth={1.5} />
                <div>
                  <p className="uppercase tracking-[0.15em] text-muted mb-1" style={{ fontSize: '0.6rem', fontWeight: 700 }}>
                    Type
                  </p>
              ...
              <div className="flex items-start gap-3">
                <Briefcase size={16} className="text-accent mt-0.5 shrink-0" strokeWidth={1.5} />
                <div>
                  <p className="uppercase tracking-[0.15em] text-muted mb-1" style={{ fontSize: '0.6rem', fontWeight: 700 }}>
                    Department
                  </p>
