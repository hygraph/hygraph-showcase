...
const PRODUCTS: Record<number, ProductDef> = {
  143: {
    ...
    weight: 7.2,
    description:
      "<p>The Aero One is our flagship road racing machine. Every gram is justified, every curve optimised in the wind tunnel.</p>",
    colors: [
  ...
  112: {
    ...
    weight: 11.4,
    description:
      "<p>Commuter S strips away everything unnecessary. What remains is the fastest, most reliable way to move through the city.</p>",
    colors: [
  ...
  140: {
    ...
    weight: 22.5,
    description:
      "<p>The Volt E1 redefines what an e-bike can be. With a 750Wh battery and intelligent motor management, range anxiety is a thing of the past.</p>",
    colors: [
  ...
  141: {
    ...
    weight: 9.1,
    description:
      "<p>Terra goes where other bikes won't. Titanium frame, wide tyre clearance, and SRAM AXS wireless shifting for when the road runs out.</p>",
    colors: [
    ...
    return NextResponse.json({
      ...
      meta: {
        pagination: {
          ...
          per_page: Object.keys(PRODUCTS).length,
          current_page: 1,
          total_pages: 1,
        },
      },
